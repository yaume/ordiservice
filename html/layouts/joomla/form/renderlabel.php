...
// 	{
// 		echo var_dump($text,$description);
...
<div class="small-2 cell">
	<label id="<?php echo $id; ?>" for="<?php echo $for; ?>"<?php if (!empty($classes)) echo ' class="text-right ' . implode(' ', $classes) . '"'; ?><?php echo $title; ?><?php echo $position; ?>>
