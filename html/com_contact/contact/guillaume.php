...
<div class="contact<?php echo $this->pageclass_sfx; ?> test" itemscope itemtype="https://schema.org/LocalBusiness">
	...
	<?php if ($this->contact->name && $tparams->get('show_name')) : ?>
		<div class="page-header" itemprop="founder" itemscope itemtype="http://schema.org/Person">
			<h2  itemprop="name">
